...
# 安全更新软件源
deb mirror+{{scheme}}://mirrors.cernet.edu.cn/api/apt/mirrorlist/ubuntu{{#official_index}}?official_index=1{{/official_index}} {{release}}-security main restricted universe multiverse
{{src}}deb-src mirror+{{scheme}}://mirrors.cernet.edu.cn/api/apt/mirrorlist/ubuntu{{#official_index}}?official_index=1{{/official_index}} {{release}}-security main restricted universe multiverse
...
# 安全更新软件源
Types: deb
URIs: mirror+{{scheme}}://mirrors.cernet.edu.cn/api/apt/mirrorlist/ubuntu{{#official_index}}?official_index=1{{/official_index}}
Suites: {{release_deb822}}-security
Components: main restricted universe multiverse
Signed-By: /usr/share/keyrings/ubuntu-archive-keyring.gpg

{{src}}Types: deb-src
{{src}}URIs: mirror+{{scheme}}://mirrors.cernet.edu.cn/api/apt/mirrorlist/ubuntu{{#official_index}}?official_index=1{{/official_index}}
